...
namespace RestaurantRecommender.AI.Helper
{
    public class DataPreparer
    {
        ...
        public static void PreprocessData(string trainingDataFile)
        {
            ...
            var restaurantIdMap = File.ReadAllLines(Environment.CurrentDirectory+ @"\Data\geoplaces2.csv")
                .Skip(1)
                .Select(l => new
                {
            ...
            var processedOutput = File.ReadAllLines(Environment.CurrentDirectory + @"\Data\rating_final.csv")
                .Skip(1).Select(r =>
                {
